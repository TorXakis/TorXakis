...
helptxt  =
  ...
  "                                  mode: 'sat(isfaction)'; 'uni(que)'; 'ran(dom)'\n"++
  ...
  "step run [<n>]                  : make <n>/[unbounded] random steps\n"++
  "\n"++
  "--------------------------------\n"++
  "\n"++
  ...
  "--------------------------------\n"++
  "\n"++
  "gen lpe <procinst> <procname>   : lpe transformation of <process instantiation>\n"++
  "gen ncomp <arg> <purpname>      : test purpose generation via `N-Complete'-algorithm\n"++
  "\n"++
  "--------------------------------\n"++
  "\n"++
