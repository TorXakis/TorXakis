...
subst' ve fis (Vsum s)                 = cstrSum $ FMX.fromOccurListT $ map (first (subst' ve fis . view)) $ FMX.toDistinctAscOccurListT s   -- TODO: discuss Damian
...
compSubst' ve fis (Vsum s)                 = cstrSum $ FMX.fromOccurListT $ map (first (compSubst' ve fis . view)) $ FMX.toDistinctAscOccurListT s   -- TODO: discuss Damian
