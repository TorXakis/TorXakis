...
stdFuncTable = FuncTable ( Map.fromList
    ...
    , (toXmlName, Map.fromList [ ( Signature [sortId_String]  sortId_String, cstrPredef SSB funcId_BoolToXml )
                               , ( Signature [sortId_String]  sortId_String, cstrPredef SSI funcId_IntToXml )
    ...
    , ("<",   Map.fromList [ ( Signature [sortId_Int,sortId_Int] sortId_Int, cstrPredef SSI funcId_ltInt ) ] )
    , ("<=",  Map.fromList [ ( Signature [sortId_Int,sortId_Int] sortId_Int, cstrPredef SSI funcId_leInt ) ] )
    , (">",   Map.fromList [ ( Signature [sortId_Int,sortId_Int] sortId_Int, cstrPredef SSI funcId_gtInt ) ] )
    , (">=",  Map.fromList [ ( Signature [sortId_Int,sortId_Int] sortId_Int, cstrPredef SSI funcId_geInt ) ] )
