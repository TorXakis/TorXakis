...
mkXor :: ValExprContext c v => c v -> ValExpr v -> ValExpr v -> Either MinError (ValExpr v)
...
mkImplies :: ValExprContext c v => c v -> ValExpr v -> ValExpr v -> Either MinError (ValExpr v)
...
mkUnaryPlus :: ValExprContext c v => c v -> ValExpr v -> Either MinError (ValExpr v)
...
mkPlus :: ValExprContext c v => c v -> ValExpr v -> ValExpr v -> Either MinError (ValExpr v)
...
mkMinus :: ValExprContext c v => c v -> ValExpr v -> ValExpr v -> Either MinError (ValExpr v)
...
mkTimes :: ValExprContext c v => c v -> ValExpr v -> ValExpr v -> Either MinError (ValExpr v)
...
mkAbs :: ValExprContext c v => c v -> ValExpr v -> Either MinError (ValExpr v)
...
mkLT :: ValExprContext c v => c v -> ValExpr v -> ValExpr v -> Either MinError (ValExpr v)
...
mkGT :: ValExprContext c v => c v -> ValExpr v -> ValExpr v -> Either MinError (ValExpr v)
...
mkLE :: ValExprContext c v => c v -> ValExpr v -> ValExpr v -> Either MinError (ValExpr v)
...
-- | Apply operator Less Equal (>=) on the provided value expressions.
mkGE :: ValExprContext c v => c v -> ValExpr v -> ValExpr v -> Either MinError (ValExpr v)
