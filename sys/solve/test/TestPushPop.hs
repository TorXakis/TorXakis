...
testPush :: SMT ()
testPush = testSequentialPushPopTemplate (EnvDefs Map.empty Map.empty Map.empty) [sortRefInt]   (const [], checkInt) []

testPushAssertion :: SMT()
testPushAssertion = testSequentialPushPopTemplate (EnvDefs Map.empty Map.empty Map.empty) [sortRefInt]  (const [], checkInt)
...
testPushAssertionPop = testSequentialPushPopTemplate (EnvDefs Map.empty Map.empty Map.empty) [sortRefInt]  (const [], checkInt)
                                                                [(createAssertions, checkAssert)]
    where
        createAssertions :: [VarId] -> [ValExpr VarId]
...
testPushAssertionPopAssertion = testSequentialPushPopTemplate (EnvDefs Map.empty Map.empty Map.empty) [sortRefInt]  (const [], checkInt)
...
testNestedRanges = testNestedPushPopTemplate (EnvDefs Map.empty Map.empty Map.empty) [sortRefInt]  (const [], checkInt)
