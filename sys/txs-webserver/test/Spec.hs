        ...
        describe "Tester" $
            it "Starts SUT & tester and takes 20 steps" $
                withCreateProcess (proc "java" ["-cp","../../examps/LuckyPeople/sut","LuckyPeople"])
                    ...
                    post (setTestUrl sId "Model" "Sut") emptyP >>= check204NoContent
...
setTestUrl :: Integer -> String -> String -> String
setTestUrl sId modelName cnectName = Prelude.concat [host, "/sessions/", show sId, "/set-test/", modelName, "/", cnectName]
