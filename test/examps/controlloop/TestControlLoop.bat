...
call %TORXAKIS% %EXAMPS%\ControlLoopModel.txs < %TEST%\ControlLoop_Stepper.txscmd
TIMEOUT /T 4 /NOBREAK
...
call %TORXAKIS% %EXAMPS%\MultipleControlLoops.txs < %TEST%\MultipleControlLoops_SpecProduce_Stepper.txscmd
TIMEOUT /T 4 /NOBREAK
...
call %TORXAKIS% %EXAMPS%\MultipleControlLoops.txs < %TEST%\MultipleControlLoops_SpecMeasure_Stepper.txscmd
TIMEOUT /T 4 /NOBREAK
...
call %TORXAKIS% %EXAMPS%\MultipleControlLoops.txs < %TEST%\MultipleControlLoops_SpecCorrect_Stepper.txscmd
TIMEOUT /T 4 /NOBREAK
...
call %TORXAKIS% %EXAMPS%\MultipleControlLoops.txs < %TEST%\MultipleControlLoops_Spec_Stepper.txscmd
TIMEOUT /T 4 /NOBREAK
